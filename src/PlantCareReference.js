...
const PlantCareReference = () => {
    ...
    const plants = [
        ...
        },
        {
            ...
            category: 'low-light',
            light: 'Low to bright indirect light',
            water: 'Water when soil is dry to touch (1-2 weeks)',
            humidity: 'Moderate to high (40-60%)',
            temp: '65-75°F (18-24°C)',
            tips: 'Beautiful patterned leaves. Tropical look. Easy care. All parts toxic - wash hands after handling.',
            difficulty: 'Easy',
            toxicToCats: 'Toxic',
            toxicToDogs: 'Toxic'
        },
        {
            id: 51,
            name: 'Hypoestes (Pink Splash Plant)',
            category: 'moderate-light',
            light: 'Bright indirect light (prefers more light)',
            water: 'Keep soil consistently moist',
            humidity: 'Moderate to high (50-70%)',
            temp: '65-75°F (18-24°C)',
            tips: 'Colorful pink/white splashed leaves. Loves humidity. Pinch tips to encourage bushiness. Vibrant foliage plant.',
            difficulty: 'Moderate',
            toxicToCats: 'Non-toxic',
            toxicToDogs: 'Non-toxic'
        },
        {
            id: 52,
            name: 'Lysimachia Aurea (Creeping Jenny)',
            category: 'moderate-light',
            light: 'Bright indirect light',
            water: 'Keep soil moist but not waterlogged',
            humidity: 'Moderate (40-50%)',
            temp: '60-75°F (15-24°C)',
            tips: 'Golden heart-shaped leaves. Trailing vine. Excellent for hanging baskets. Very fast grower.',
            difficulty: 'Easy',
            toxicToCats: 'Non-toxic',
            toxicToDogs: 'Non-toxic'
        },
        {
            id: 53,
            name: 'Rhaphidophora Decursiva (Dragon Tail)',
            category: 'moderate-light',
            light: 'Bright indirect light',
            water: 'Water when soil is dry to touch',
            humidity: 'Moderate to high (50-60%)',
            temp: '65-75°F (18-24°C)',
            tips: 'Unique deeply lobed leaves. Rare tropical houseplant. Climbing or trailing growth habit. Statement plant.',
            difficulty: 'Moderate',
            toxicToCats: 'Toxic',
            toxicToDogs: 'Toxic'
        },
        {
            ...
            humidity: 'Moderate to high (50-70%)',
            temp: '70-80°F (21-27°C)',
            tips: 'Elegant tropical palm. Tall elegant stems with feathery fronds. Prefers warmth & humidity. Air purifier.',
            difficulty: 'Moderate',
            toxicToCats: 'Non-toxic',
            toxicToDogs: 'Non-toxic'
        },
        {
            id: 55,
            name: 'Hydrangea (Potted)',
            category: 'moderate-light',
            light: 'Bright indirect light',
            water: 'Keep soil consistently moist during blooming',
            humidity: 'High (60-80%)',
            temp: '60-70°F (15-21°C)',
            tips: 'Seasonal indoor bloomer. Can change color based on soil pH. Prefers cooler temperatures. Temporary houseplant.',
            difficulty: 'Moderate',
            toxicToCats: 'Toxic',
            toxicToDogs: 'Toxic'
        },
        {
            id: 56,
            name: 'Tete a Tete Daffodil (Narcissus)',
            category: 'bright-light',
            light: 'Bright indirect light',
            water: 'Keep soil moist during growth & bloom',
            humidity: 'Moderate (40-50%)',
            temp: '55-65°F (13-18°C)',
            tips: 'Indoor forcing bulb. Early spring bloomer. Fragrant yellow flowers. After blooming, plant outdoors for next year.',
            difficulty: 'Easy',
            toxicToCats: 'Toxic',
            toxicToDogs: 'Toxic'
        },
        {
            id: 57,
            name: 'Chives (Kitchen Herb)',
            category: 'moderate-light',
            light: 'Bright indirect to direct light (prefers 6+ hours)',
            water: 'Keep soil consistently moist',
            humidity: 'Average (30-40%)',
            temp: '60-70°F (15-21°C)',
            tips: 'Culinary herb. Harvest tips regularly to encourage growth. Produces purple flowers. Very easy indoor herb.',
            difficulty: 'Easy',
            toxicToCats: 'Non-toxic',
            toxicToDogs: 'Non-toxic'
        },
        {
            id: 58,
            name: 'Oregano (Kitchen Herb)',
            category: 'bright-light',
            light: 'Bright indirect to direct light (6+ hours)',
            water: 'Let dry between waterings',
            humidity: 'Average (30-40%)',
            temp: '60-75°F (15-24°C)',
            tips: 'Mediterranean culinary herb. Drought tolerant. Pinch regularly to keep bushy. Great for cooking & tea.',
            difficulty: 'Easy',
            toxicToCats: 'Non-toxic',
            toxicToDogs: 'Non-toxic'
        },
        {
            id: 59,
            name: 'Rosemary (Kitchen Herb)',
            category: 'bright-light',
            light: 'Bright indirect to direct light (6+ hours)',
            water: 'Let dry between waterings',
            humidity: 'Average (30-40%)',
            temp: '60-70°F (15-21°C)',
            tips: 'Mediterranean herb. Drought & heat tolerant. Prune regularly for bushiness. Great for cooking & aromatics.',
            difficulty: 'Moderate',
            toxicToCats: 'Non-toxic',
            toxicToDogs: 'Non-toxic'
        },
        {
            id: 60,
            name: 'Thyme Lemon (Kitchen Herb)',
            category: 'bright-light',
            light: 'Bright indirect to direct light (6+ hours)',
            water: 'Let dry between waterings',
            humidity: 'Average (30-40%)',
            temp: '60-75°F (15-24°C)',
            tips: 'Culinary herb with lemon scent. Very drought tolerant. Pinch tips to encourage bushiness. Great for cooking & tea.',
            difficulty: 'Easy',
            toxicToCats: 'Non-toxic',
            toxicToDogs: 'Non-toxic'
        }
