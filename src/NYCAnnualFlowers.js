...
const NYCAnnualFlowers = () => {
    ...
    const flowers = [
        ...
        },
        {
            ...
            temp: '70-85°F (21-29°C)',
            plantTime: 'After frost (May 20)',
            tips: 'Unique spiky flowers. Self-seeds readily. Airy, delicate appearance. Hummingbird magnet.',
            color: 'Pink, white, purple varieties',
            maintenance: 'Easy'
        },
        {
            id: 17,
            ...
            temp: '75-85°F (24-29°C)',
            plantTime: 'After frost (May 20)',
            tips: 'Extreme heat & drought lover. Succulent-like. Perfect for containers. Closes at night.',
            color: 'Pink, red, orange, yellow, white, purple',
            maintenance: 'Easy'
        },
        {
            id: 18,
            name: 'Bachelor\'s Buttons (Cornflower)',
            bloom: 'June-September',
            height: 'Medium to tall (12-36")',
            sunlight: 'Full sun to part shade',
            water: 'Drought tolerant once established',
            temp: '60-75°F (15-24°C)',
            plantTime: 'Direct seed early spring (April) or fall',
            tips: 'Easy to grow. Self-seeds. Great cut flowers. Cool season lover. Attracts pollinators.',
            color: 'Blue, pink, white, purple varieties',
            maintenance: 'Easy'
        },
        {
            id: 19,
            name: 'Angelonia (Angelflower)',
            bloom: 'June-October',
            ...
            temp: '70-85°F (21-29°C)',
            plantTime: 'After frost (May 15)',
            tips: 'Heat & humidity tolerant. Spiky flower spires. All-season bloomer. Great for cutting.',
            color: 'White, pink, purple, blue varieties',
            maintenance: 'Easy'
        },
        {
            id: 20,
            ...
            temp: '65-75°F (18-24°C)',
            plantTime: 'After frost (May 15)',
            tips: 'Double flowers on tall stems. Shade tolerant. Tropical look. Self-seeds for next year.',
            color: 'Pink, red, white, purple, bicolor',
            maintenance: 'Easy'
        },
        {
            id: 21,
            name: 'Dianthus (Pinks/Carnations)',
            bloom: 'May-October',
            height: 'Short to medium (6-24")',
            sunlight: 'Full sun to part shade',
            water: 'Water regularly',
            temp: '60-75°F (15-24°C)',
            plantTime: 'Late April or late summer (August)',
            tips: 'Fragrant spiced scent. Cool season lover. Deadhead for continuous blooms. Many varieties available.',
            color: 'Pink, red, white, bicolor, striped',
            maintenance: 'Moderate'
        },
        {
            id: 22,
            ...
            temp: '65-75°F (18-24°C)',
            plantTime: 'After frost (May 15)',
            tips: 'Tiny papery flowers ideal for drying. Long vase life. Airy, delicate look. Very low maintenance.',
            color: 'Purple, pink, white, yellow varieties',
            maintenance: 'Easy'
        },
        {
            id: 23,
            name: 'Browallia (Sapphire Flower)',
            bloom: 'June-October',
            height: 'Short to medium (8-18")',
            sunlight: 'Part shade to shade',
            water: 'Keep soil moist',
            temp: '65-75°F (18-24°C)',
            plantTime: 'After frost (May 15)',
            tips: 'Shade tolerant. Delicate star-like flowers. Trailing varieties for baskets. Continuous bloomer.',
            color: 'Blue, white varieties',
            maintenance: 'Easy'
        },
        {
            id: 24,
            name: 'Tithonia (Mexican Sunflower)',
            bloom: 'July-October',
            height: 'Tall (24-48")',
            sunlight: 'Full sun',
            water: 'Drought tolerant once established',
            temp: '75-85°F (24-29°C)',
            plantTime: 'After frost (May 20)',
            tips: 'Heat & drought lover. Tropical orange blooms. Hummingbird magnet. Attracts beneficial insects.',
            color: 'Orange, yellow varieties',
            maintenance: 'Easy'
        },
        {
            id: 25,
            ...
            temp: '65-75°F (18-24°C)',
            plantTime: 'After frost (May 15)',
            tips: 'Unique fan-shaped flowers. Cascading habit perfect for hanging baskets. All-season bloomer.',
            color: 'Blue, purple, white, pink varieties',
            maintenance: 'Easy'
        }
    ];
